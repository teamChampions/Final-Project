...
exports.getAllpostsByCategory = exports.addPost = exports.getAllposts = void 0;
...
var getAllpostsByCategory = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        try {
            ...
            posts_schema_1.default.find({ category: req.params.category })
                .populate({ path: "users", select: "_id userName" })
                .populate({
                path: "comments",
                populate: {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, posts_schema_1.default.create({
