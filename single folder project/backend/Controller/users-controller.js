...
var signup = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userPassword, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                userPassword = req.body.password;
                return [4 /*yield*/, bcryptjs_1.default.hash(userPassword, 9, function (err, hash) { return __awaiter(void 0, void 0, void 0, function () {
                        var newUser, err_3;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                ...
                                case 1:
                                    _a.trys.push([1, 3, , 4]);
                                    return [4 /*yield*/, users_schema_1.default.create({
...
var login = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, user, _b, err_4;
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, users_schema_1.default.findById(userId, "_id email")];
            case 2:
                user = _b.sent();
                if (!user) {
