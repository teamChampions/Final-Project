...
exports.deleteComment = exports.getUserComments = exports.addComment = void 0;
...
var deleteComment = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var comment, postId, post, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
                return [4 /*yield*/, comment_schema_1.default.findOne({ _id: req.params.id })];
            case 1:
                comment = _a.sent();
...
var getUserComments = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userComments, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
