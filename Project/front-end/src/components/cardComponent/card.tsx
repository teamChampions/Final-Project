    ...
    <Card
      ...
      actions={[
        <span onClick={likePost}>
          {
						liked()?<i className="fa fa-thumbs-up icon-style" aria-hidden="true"></i>:
						<i className="fa fa-thumbs-o-up icon-style" aria-hidden="true"></i>
					}
					<span className="post-info">{data.likes.length}</span>
        </span>,
				<span>
				<i className="fa fa-comments-o icon-style"  title="Add comment" onClick={handleAddComment} aria-hidden="true"></i>
